  ...
  if ($prod) {
      foreach ($prod as $value) {
        ...
        <div class="col-lg-4">
            <div class="trainer-item">
                <div class="image-thumb">
                <a href="./views/product-details.php?prod_id=$id">
                ...
                <div class="down-content">
                    ...
                    <ul class="social-icons">
                        ...
                        <li><button type="button" onclick="addItemToCart($id,1);" class="btn btn-primary" style="color:white;">+ Add To Cart</button></li>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-100" src=".$img" alt="First slide" style="width: 100%; ">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src=".$img" alt="Second slide" style="width: 100%; ">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src=".$img" alt="Third slide">
          </div>
        </div>
        <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev" style="width: 100%; height:10%;">
      ...
      <div class="contact-form">
        <form action="#" id="contact">
          ...
          <div class="main-button">
              <button type="button" onclick="addItemToCart($id,1);">Add to cart</button>
          </div>
        </form>
      </div>
              ...
              <div class="trainer-item">
                  ...
                  <div class="down-content">
                      ...
                      <ul class="social-icons">
                          ...
                          <li><button type="button" href="./views/product-details/$id" onclick="addItemToCart($id,1);" class="btn btn-primary" style="color:white;">+ Add To Cart</button></li>
                          <li><a  href="../initialize.php?prod_id=$id&price=$price" class="btn btn-success" style="color:white;"> Buy</a></li>
                      </ul>
                  </div>
              </div>
          </div>
