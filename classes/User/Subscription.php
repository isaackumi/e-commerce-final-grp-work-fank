...
class Subscription extends Connection
{
    ...
    public function userWithSubscription(){
      ...
      header("Location: http://13.68.189.1/sites/Fank_final/index.php");
    ...
    public static function paystackInit(){
      ...
      $callback_url = 'http://13.68.189.1/sites/Fank_final/views/verify-subscription.php';
      ...
      curl_setopt_array($curl, array(
        ...
        CURLOPT_HTTPHEADER => [
          "authorization: Bearer sk_test_e83e56b0290a42027f549b171a08cefa3a21f145", //replace this with your own test key
    ...
    public function paystackCallback(){
      ...
      curl_setopt_array($curl, array(
        ...
        CURLOPT_HTTPHEADER => [
          ...
          "authorization: Bearer sk_test_e83e56b0290a42027f549b171a08cefa3a21f145",
          "cache-control: no-cache"
        ],
      ));
      ...
      if('success' == $tranx->data->status){
        ...
        header("Location: http://13.68.189.1/sites/Fank_final/views/subscription-success.php");
